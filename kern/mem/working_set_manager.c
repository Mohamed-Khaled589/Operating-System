...
inline struct WorkingSetElement* env_page_ws_list_create_element(struct Env* e, uint32 virtual_address)
{
	...
	struct WorkingSetElement* NewWorkingSet =(struct WorkingSetElement*) kmalloc(sizeof(struct WorkingSetElement));
	if(NewWorkingSet==NULL)
	{
		panic("new working set not created ");
	}
	else
	{
		NewWorkingSet->virtual_address=virtual_address;
//		NewWorkingSet->empty=0;
//		NewWorkingSet->time_stamp = 0;
//		NewWorkingSet->sweeps_counter = 0;
