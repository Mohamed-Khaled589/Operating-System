...
void env_set_nice(struct Env* e, int nice_value)
{
	...
	{
		fixed_point_t p1=fix_div(fix_int(e->recent_cpu),fix_int(4));
		fixed_point_t p2=fix_mul(fix_int(e->nice_value),fix_int(2));
...
int env_get_recent_cpu(struct Env* e)
{
	...
	//Comment the following line
	//panic("Not implemented yet");
	fixed_point_t rec= fix_mul(fix_int(e->recent_cpu),fix_int(100));
	return fix_round(rec);
}
int get_load_average()
{
	...
	//Comment the following line
	//panic("Not implemented yet");
	fixed_point_t ret= fix_mul(fix_int(load_avg),fix_int(100));
	return fix_round(ret);
}
/********* for BSD Priority Scheduler *************/
//==================================================================================//
